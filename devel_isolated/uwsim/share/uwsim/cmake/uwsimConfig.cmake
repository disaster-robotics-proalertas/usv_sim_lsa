...
if("TRUE" STREQUAL "TRUE")
  set(uwsim_SOURCE_PREFIX /home/lsa/ocean2/src/underwater_simulation/uwsim)
  set(uwsim_DEVEL_PREFIX /home/lsa/ocean2/devel_isolated/uwsim)
  set(uwsim_INSTALL_PREFIX "")
  set(uwsim_PREFIX ${uwsim_DEVEL_PREFIX})
else()
  set(uwsim_SOURCE_PREFIX "")
  set(uwsim_DEVEL_PREFIX "")
  set(uwsim_INSTALL_PREFIX /home/lsa/ocean2/install_isolated)
...
if(NOT "/home/lsa/ocean2/src/underwater_simulation/uwsim/include " STREQUAL " ")
  set(uwsim_INCLUDE_DIRS "")
  set(_include_dirs "/home/lsa/ocean2/src/underwater_simulation/uwsim/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'uwsim' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mario Prats <marioprats@gmail.com>, Javier Perez <perezsolerj@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'uwsim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lsa/ocean2/src/underwater_simulation/uwsim/${idir}'.  Ask the maintainer 'Mario Prats <marioprats@gmail.com>, Javier Perez <perezsolerj@gmail.com>' to fix it.")
    endif()
