...
#include <liftdragww/liftdragww.h>
...
using namespace gazebo;
  ...
  GZ_REGISTER_MODEL_PLUGIN(LiftDragWW)

/////////////////////////////////////////////////
LiftDragWW::LiftDragWW() : cla(1.0), cda(0.01), cma(0.01), rho(1.2041)
{
gzerr << "-----------------------------------";
ROS_INFO("------------------------------LiftDragWW OBJECT CREATED!!!!");
...
/////////////////////////////////////////////////
void LiftDragWW::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
ROS_INFO("------------------------------LiftDragWW loaded!!!!");


  GZ_ASSERT(_model, "LiftDragWW _model pointer is NULL");
  GZ_ASSERT(_sdf, "LiftDragWW _sdf pointer is NULL");
  this->model = _model;
  this->modelName = _model->GetName();
  this->sdf = _sdf;

  this->world = this->model->GetWorld();
  GZ_ASSERT(this->world, "LiftDragWW world pointer is NULL");

  this->physics = this->world->GetPhysicsEngine();
  GZ_ASSERT(this->physics, "LiftDragWW physics pointer is NULL");
...
/////////////////////////////////////////////////
void LiftDragWW::Init()
{
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          boost::bind(&LiftDragWW::OnUpdate, this));
}

/////////////////////////////////////////////////
void LiftDragWW::OnUpdate()
{
