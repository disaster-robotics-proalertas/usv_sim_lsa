...
with open('polar_diagram_2.txt', 'rb') as file1, open('polar_diagram_2-5.txt', 'rb') as file2, open('polar_diagram_3.txt', 'rb') as file3, open('polar_diagram_3-5.txt', 'rb') as file4, open('polar_diagram_4.txt', 'rb') as file5:
    ...
    reader5 = list(reader5)
    reader5 = [list(x) for x in zip(*reader5)]
    ...
    r5 = [float(i) for i in reader5[0]]
    theta5 = [float(i) for i in reader5[2]]
    theta5 = [math.radians(i) for i in theta5]
    ...
    plt.legend(['2 m/s', '2,5 m/s', '3 m/s', '3,5 m/s', '4 m/s'], loc='upper right')
    plt.show()
