...
/////////////////////////////////////////////////
USV_Sailing_Plugin::USV_Sailing_Plugin() : cla(1.0), cda(0.01), cma(0.01), rho(1.2041)
{
...
/////////////////////////////////////////////////
void USV_Sailing_Plugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
...
void USV_Sailing_Plugin::OnUpdate()
{
...
/////////////////////////////////////////////////
void USV_Sailing_Plugin::OnUpdateRudder()
{
...
void USV_Sailing_Plugin::OnUpdateKeel()
{
...
void USV_Sailing_Plugin::ReadWaterCurrent(const geometry_msgs::Vector3::ConstPtr& _msg)
{
