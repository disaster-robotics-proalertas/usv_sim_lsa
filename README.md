...
| Launch File | Gazebo World file | UWSIM XML File | Autogenerated UWSIM file | Boat launch file |
|-------------|-------------------|----------------|--------------------------|------------------|
|robots_start |  |  |  |  |  | 				
|scenario1 | world/empty.world | scenario1.xml | scenario1_spawner.launch | models/spawn_boat_diff.launch | 
|scenario2 | world/empty.world | scenario2.xml | scenario2_spawner.launch | models/spawn_boat_diff.launch | 
|scenario3 | world/empty.world | scenario3.xml | scenario3_spawner.launch | models/spawn_boat_diff.launch | 
