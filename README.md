...
|-------------|-------------------|----------------|--------------------------|------------------|
|<sub>robots_start</sub> | <sub>world/empty.world</sub> | <sub>robots_start.xml</sub> | <sub>robots_start_spawner.launch</sub> | <sub>models/spawn_boat_diff.launch spawn_airboat.launch models/spawn_boat_rudder.launch models/spawn_sailboat.launch</sub> |
