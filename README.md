...
|-------------|-------------------|----------------|--------------------------|------------------|
|<sub>robots_start</sub> | <sub>world/empty.world</sub> | <sub>robots_start.xml</sub> | <sub>robots_start_spawner.launch</sub> | <sub>models/spawn_boat_diff.launch<br> spawn_airboat.launch <br>models/spawn_boat_rudder.launch <br>models/spawn_sailboat.launch</sub> |
